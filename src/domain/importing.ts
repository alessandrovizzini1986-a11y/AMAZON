...
export const IMPORT_SPECS: Record<string, EntitySpec> = {
  vehicles: {
    ...
    fields: [
      ...
      { key: "alimentazione", label: "Alimentazione", required: false, type: "enum", enumValues: ["DIESEL", "DIESEL_HVO", "BENZINA", "ELETTRICO", "METANO", "GPL", "IBRIDO"], aliases: ["fuel", "carburante"], note: "DIESEL_HVO = compatibile EN 15940. Default: DIESEL" },
      { key: "hvoCompatibile", label: "Compatibile HVO", required: false, type: "boolean", aliases: ["hvo"], note: "SI/NO" },
      { key: "immatricolazione", label: "Data immatricolazione", required: false, type: "date", aliases: ["first registration"] },
      { key: "stationCode", label: "Codice stazione", required: true, type: "string", aliases: ["stazione", "station", "sede", "nuova ds", "ds"], note: "Codice stazione esistente (es. DER1)" },
      { key: "stato", label: "Stato", required: false, type: "enum", enumValues: ["ATTIVO", "IN_OFFICINA", "SOSTITUTIVO", "UFFICIO", "DISMESSO"], note: "Default: ATTIVO" },
      { key: "kmAttuali", label: "Km attuali", required: false, type: "int", aliases: ["km", "chilometri"] },
      { key: "canoneMese", label: "Canone €/mese", required: false, type: "decimal", aliases: ["canone", "tariffa", "canone mensile", "monthly rate"] },
      { key: "franchigiaDanni", label: "Franchigia danni €", required: false, type: "decimal", aliases: ["fr.danni", "franchigia"] },
      { key: "leasingCompany", label: "Società noleggio", required: false, type: "string", aliases: ["leasing", "noleggiatore", "società noleggio"] },
      { key: "contrattoLeasingNo", label: "N. contratto (N° RA)", required: false, type: "string", aliases: ["contratto", "n° ra", "ra"] },
      { key: "tipoContratto", label: "Tipo contratto", required: false, type: "enum", enumValues: ["MT", "LT", "BT", "SOST", "UFFICIO"], aliases: ["tipo"], note: "MT=medio termine, LT=lungo termine, BT=breve termine, SOST=sostitutivo" },
      { key: "contrattoDataInizio", label: "Data inizio contratto", required: false, type: "date", aliases: ["data inizio"] },
      { key: "contrattoDataFine", label: "Data fine contratto", required: false, type: "date", aliases: ["data fine"] },
  ...
  leases: {
    ...
    fields: [
      { key: "targa", label: "Targa", required: true, type: "string" },
      { key: "canoneMese", label: "Canone €/mese", required: true, type: "decimal", aliases: ["canone", "tariffa"] },
      { key: "leasingCompany", label: "Società leasing", required: true, type: "string", aliases: ["leasing"] },
      { key: "contrattoLeasingNo", label: "N. contratto", required: false, type: "string", aliases: ["contratto", "n° ra"] },
      { key: "franchigiaDanni", label: "Franchigia danni €", required: false, type: "decimal", aliases: ["fr.danni", "franchigia"] },
    ],
  },
  movements: {
